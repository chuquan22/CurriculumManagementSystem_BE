        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Major_Semester_semester_id",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 2023, new DateTime(2023, 10, 10, 3, 5, 34, 607, DateTimeKind.Local).AddTicks(3338), "Fall", new DateTime(2023, 5, 9, 0, 0, 0, 0, DateTimeKind.Unspecified) });
            ...
            migrationBuilder.InsertData(
                table: "Major",
                columns: new[] { "major_id", "is_active", "major_code", "major_english_name", "major_name", "semester_id" },
                values: new object[,]
                {
                    { 1, true, "GD", "Graphic Design", "Thiết kế đồ họa", 1 },
                    { 2, true, "IT", "Information technology", "Công nghệ thông tin", 1 },
                    { 3, true, "BA", "Business Administration", "Quản trị kinh doanh", 1 },
                    { 4, true, "AE", "Automation Engineering", "Kỹ thuật tự động hóa", 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2023, 10, 10, 0, 0, 0, 0, DateTimeKind.Local), 1, "GD", "", "Thiết kế đồ họa", 1, "360/QĐ-CĐFPL", "Graphic Design", 1 });

            migrationBuilder.InsertData(
                table: "Curriculum",
                columns: new[] { "curriculum_id", "approved_date", "batch_id", "curriculum_code", "curriculum_description", "curriculum_name", "curriculum_status", "decision_No", "english_curriculum_name", "specialization_id" },
                values: new object[] { 2, new DateTime(2023, 10, 10, 0, 0, 0, 0, DateTimeKind.Local), 2, "SE", "", "kĩ sư phần mềm", 0, "360/QĐ-CĐFPL", "Software Engineering", 4 });
