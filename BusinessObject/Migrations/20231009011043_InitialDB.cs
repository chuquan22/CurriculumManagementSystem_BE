...
namespace BusinessObject.Migrations
{
    public partial class InitialDB : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Subject",
                columns: new[] { "subject_id", "assessment_method_id", "credit", "english_subject_name", "is_active", "learning_method_id", "option", "subject_code", "subject_name" },
                values: new object[] { 1, 1, 10, "Project Capstone", true, 1, "abc", "SEP490", "Đồ án" });
