    ...
    public partial class InitialDB : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 2023, new DateTime(2023, 10, 17, 23, 16, 46, 394, DateTimeKind.Local).AddTicks(5840), "Fall", new DateTime(2023, 5, 9, 0, 0, 0, 0, DateTimeKind.Unspecified) },
            ...
            migrationBuilder.InsertData(
                table: "Combo",
                columns: new[] { "combo_id", "combo_code", "combo_description", "combo_english_name", "combo_name", "combo_no", "is_active", "specialization_id" },
                values: new object[,]
                {
                    { 1, ".NET", "lập trình web với ngôn ngữ C#", "C# Programing", "Lập trình C#", 1, true, 4 },
                    { 2, "JS", "kĩ sư lập trình với ngôn ngữ Nhật", "Japan Software", "kĩ sư Nhật Bản", 2, true, 3 },
                    { 3, "KS", "kĩ sư lập trình với ngôn ngữ Hàn", "Korea Software", "kĩ sư Hàn Quốc", 1, false, 2 },
                    { 4, "NodeJS", "lập trình web với NodeJS", "NodeJS Programing", "Lập trình NodeJS", 2, true, 1 }
                });

            migrationBuilder.InsertData(
                table: "Curriculum",
                columns: new[] { "curriculum_id", "approved_date", "batch_id", "curriculum_code", "curriculum_description", "curriculum_name", "decision_No", "english_curriculum_name", "is_active", "specialization_id", "total_semester" },
                values: new object[,]
                {
                    { 1, new DateTime(2023, 10, 17, 0, 0, 0, 0, DateTimeKind.Local), 1, "GD", "", "Thiết kế đồ họa", "360/QĐ-CĐFPL", "Graphic Design", true, 1, 7 },
                    { 2, new DateTime(2023, 10, 17, 0, 0, 0, 0, DateTimeKind.Local), 4, "GD", "", "Thiết kế mĩ thuật số", "360/QĐ-CĐFPL", "Graphic Design", true, 1, 7 },
                    { 3, new DateTime(2023, 10, 17, 0, 0, 0, 0, DateTimeKind.Local), 3, "SE", "", "kĩ sư phần mềm", "360/QĐ-CĐFPL", "Software Engineering", true, 4, 7 },
                    { 4, new DateTime(2023, 10, 17, 0, 0, 0, 0, DateTimeKind.Local), 2, "SE", "", "kĩ thuật phần mềm", "360/QĐ-CĐFPL", "Software Engineering", true, 4, 7 },
                    { 5, new DateTime(2023, 10, 17, 0, 0, 0, 0, DateTimeKind.Local), 3, "CM", "", "quản lí học liệu", "360/QĐ-CĐFPL", "Curriculum Management", true, 2, 7 },
                    { 6, new DateTime(2023, 10, 17, 0, 0, 0, 0, DateTimeKind.Local), 3, "SS", "", "kĩ năng mềm", "360/QĐ-CĐFPL", "Soft Skill", true, 1, 7 },
                    { 7, new DateTime(2023, 10, 17, 0, 0, 0, 0, DateTimeKind.Local), 3, "SWP", "", "kĩ năng lập trình web", "360/QĐ-CĐFPL", "Skill Web Program", false, 1, 7 },
                    { 8, new DateTime(2023, 10, 17, 0, 0, 0, 0, DateTimeKind.Local), 3, "SS", "", "kĩ năng mềm", "360/QĐ-CĐFPL", "Soft Skill", true, 1, 7 }
                });
