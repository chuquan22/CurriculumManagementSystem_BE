        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 3, "Nguyen Phong Hao", 1, "Nghe An", "haotest@gmail.com", "admin", "admin", 984739845, "Active" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2023, 10, 5, 0, 0, 0, 0, DateTimeKind.Local), 1, "GD", "", "Thiết kế đồ họa", "Active", "360/QĐ-CĐFPL", "Graphic Design", 1 });

            migrationBuilder.InsertData(
                table: "Curriculum",
                columns: new[] { "curriculum_id", "approved_date", "batch_id", "curriculum_code", "curriculum_description", "curriculum_name", "curriculum_status", "decision_No", "english_curriculum_name", "specialization_id" },
                values: new object[] { 2, new DateTime(2023, 10, 5, 0, 0, 0, 0, DateTimeKind.Local), 2, "SE", "", "kĩ sư phần mềm", "Active", "360/QĐ-CĐFPL", "Software Engineering", 4 });
