    ...
    public partial class InitialDB : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "specialization_id", "is_active", "major_id", "specialization_code", "specialization_english_name", "specialization_name" },
                values: new object[,]
                {
                    { 1, true, 1, "IED", "Interior and exterior design", "Thiết kế nội và ngoại thất" },
                    { 2, true, 1, "FMA", "Filmmaking and advertising", "Dựng phim và quảng cáo" },
                    { 3, true, 1, "IED", "Interior and exterior design", "Thiết kế nội và ngoại thất" },
                    { 4, true, 2, "SE", "Software Engineering", "kĩ thuật phần mềm" },
                    { 5, true, 2, "WP", "web programming", "lập trình web" },
                    { 6, true, 2, "GP", "game programming", "lập trình game" }
                });

            migrationBuilder.InsertData(
                table: "User",
                columns: new[] { "user_id", "full_name", "is_active", "role_id", "user_address", "user_email", "user_name", "user_password", "user_phone" },
                values: new object[,]
                {
                    { 1, "Chu Quang Quan", true, 1, "Ha Nam", "chuquan2k1@gmail.com", "QuanCQ", "12345", 349457905 },
                    { 2, "Nguyen Thi Thu", true, 2, "Thai Binh", "nguyenthu120801@gmail.com", "ThuNT", "12345", 984739845 },
                    { 3, "Nguyen Phong Hao", true, 1, "Nghe An", "haotest@gmail.com", "admin", "admin", 984739845 }
                });

            migrationBuilder.InsertData(
                table: "Curriculum",
                columns: new[] { "curriculum_id", "approved_date", "batch_id", "curriculum_code", "curriculum_description", "curriculum_name", "curriculum_status", "decision_No", "english_curriculum_name", "is_active", "specialization_id" },
                values: new object[] { 1, new DateTime(2023, 10, 9, 0, 0, 0, 0, DateTimeKind.Local), 1, "GD", "", "Thiết kế đồ họa", 1, "360/QĐ-CĐFPL", "Graphic Design", true, 1 });

            migrationBuilder.InsertData(
                table: "Curriculum",
                columns: new[] { "curriculum_id", "approved_date", "batch_id", "curriculum_code", "curriculum_description", "curriculum_name", "curriculum_status", "decision_No", "english_curriculum_name", "is_active", "specialization_id" },
                values: new object[] { 2, new DateTime(2023, 10, 9, 0, 0, 0, 0, DateTimeKind.Local), 2, "SE", "", "kĩ sư phần mềm", 0, "360/QĐ-CĐFPL", "Software Engineering", true, 4 });

            migrationBuilder.InsertData(
                table: "Subject",
                columns: new[] { "subject_id", "assessment_method_id", "credit", "english_subject_name", "exam_total", "is_active", "learning_method_id", "option", "subject_code", "subject_name", "total_time", "total_time_class" },
                values: new object[] { 1, 1, 10, "Project Capstone", 3, true, 1, "abc", "SEP490", "Đồ án", 70, 40 });
