        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, 5, 2023, new DateTime(2023, 8, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), "Summer", new DateTime(2023, 5, 5, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 3, 4, 2023, new DateTime(2023, 4, 14, 0, 0, 0, 0, DateTimeKind.Unspecified), "Spring", new DateTime(2023, 1, 3, 0, 0, 0, 0, DateTimeKind.Unspecified) },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "formal education", new DateTime(2023, 10, 30, 0, 0, 0, 0, DateTimeKind.Local), 1, "GD-IED-CD-18.1", "", "Thiết kế đồ họa", "360/QĐ-CĐFPL", "Associate Degree", "Graphic Design", true, 1, 7, null },
                    { 2, "formal education", new DateTime(2023, 10, 30, 0, 0, 0, 0, DateTimeKind.Local), 4, "GD-IED-IC-19.1", "", "Thiết kế mĩ thuật số", "360/QĐ-CĐFPL", "International associate degree", "Graphic Design", true, 1, 7, null },
                    { 3, "formal education", new DateTime(2023, 10, 30, 0, 0, 0, 0, DateTimeKind.Local), 3, "SE-SE-IC-18.3", "", "kĩ sư phần mềm", "360/QĐ-CĐFPL", "International associate degree", "Software Engineering", true, 4, 7, null },
                    { 4, "formal education", new DateTime(2023, 10, 30, 0, 0, 0, 0, DateTimeKind.Local), 2, "SE-SE-CD-18.2", "", "kĩ thuật phần mềm", "360/QĐ-CĐFPL", "Associate Degree ", "Software Engineering", true, 4, 7, null },
                    { 5, "formal education", new DateTime(2023, 10, 30, 0, 0, 0, 0, DateTimeKind.Local), 3, "CM-FMA-TC-18.3", "", "quản lí học liệu", "360/QĐ-CĐFPL", "Vocational Secondary", "Curriculum Management", true, 2, 7, null },
                    { 6, "formal education", new DateTime(2023, 10, 30, 0, 0, 0, 0, DateTimeKind.Local), 3, "SS-IED-TC-18.3", "", "kĩ năng mềm", "360/QĐ-CĐFPL", "Vocational Secondary", "Soft Skill", true, 1, 7, null },
                    { 7, "formal education", new DateTime(2023, 10, 30, 0, 0, 0, 0, DateTimeKind.Local), 2, "SWP-WP-TC-18.2", "", "kĩ năng lập trình web", "360/QĐ-CĐFPL", "Vocational Secondary", "Skill Web Program", false, 5, 7, null },
                    { 8, "formal education", new DateTime(2023, 10, 30, 0, 0, 0, 0, DateTimeKind.Local), 3, "SS-IED-TC-18.3", "", "kĩ năng mềm", "360/QĐ-CĐFPL", "Vocational Secondary", "Soft Skill", true, 1, 7, null }
                });
