        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DegreeLeveldegree_level_id = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Batch", x => x.batch_id);
                    table.ForeignKey(
                        name: "FK_Batch_DegreeLevel_DegreeLeveldegree_level_id",
                        column: x => x.DegreeLeveldegree_level_id,
            ...
            migrationBuilder.InsertData(
                table: "Batch",
                columns: new[] { "batch_id", "DegreeLeveldegree_level_id", "batch_name", "batch_order" },
                values: new object[,]
                {
                    { 1, null, "7.1", 1 },
                    { 2, null, "17", 1 },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Batch_DegreeLeveldegree_level_id",
                table: "Batch",
                column: "DegreeLeveldegree_level_id");
