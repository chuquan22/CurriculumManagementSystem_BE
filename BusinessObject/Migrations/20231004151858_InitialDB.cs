    ...
    public partial class InitialDB : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Subject_PreRequisite_pre_requisite_id",
                        column: x => x.pre_requisite_id,
            ...
            migrationBuilder.InsertData(
                table: "User",
                columns: new[] { "user_id", "full_name", "role_id", "user_address", "user_email", "user_name", "user_password", "user_phone", "user_status" },
                values: new object[] { 3, "Nguyen Phong Hao", 1, "Nghe An", "haotest@gmail.com", "admin", "admin", 984739845, "Active" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Subject_pre_requisite_id",
                table: "Subject",
