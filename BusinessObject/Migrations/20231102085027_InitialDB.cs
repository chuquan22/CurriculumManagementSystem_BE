    ...
    public partial class InitialDB : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "learning_method_id", "learning_method_name" },
                values: new object[,]
                {
                    { 1, "Online Learing" },
                    { 2, "Balence" }
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, true, "6210402", "Graphic Design", "Thiết kế đồ họa" },
                    { 2, true, "6215642", "Information technology", "Công nghệ thông tin" },
                    { 3, true, "6516427", "Business Administration", "Quản trị kinh doanh" },
                    { 4, true, "6318672", "Automation Engineering", "Kỹ thuật tự động hóa" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 6, 2023, new DateTime(2023, 12, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), "Fall", new DateTime(2023, 9, 9, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 2, 5, 2023, new DateTime(2023, 8, 8, 0, 0, 0, 0, DateTimeKind.Unspecified), "Summer", new DateTime(2023, 5, 5, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 3, 4, 2023, new DateTime(2023, 4, 4, 0, 0, 0, 0, DateTimeKind.Unspecified), "Spring", new DateTime(2023, 1, 3, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 4, 3, 2022, new DateTime(2022, 12, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), "Fall", new DateTime(2022, 9, 9, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 5, 2, 2022, new DateTime(2022, 8, 8, 0, 0, 0, 0, DateTimeKind.Unspecified), "Summer", new DateTime(2022, 5, 5, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 6, 1, 2022, new DateTime(2022, 4, 4, 0, 0, 0, 0, DateTimeKind.Unspecified), "Spring", new DateTime(2022, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 3, true, 1, 2, "6526432", "Interior and Exterior Design", "Thiết kế nội và ngoại thất" },
                    { 4, true, 2, 2, "6764432", "Software Engineering", "kĩ thuật phần mềm" },
                    { 5, true, 2, 2, "6266132", "Web Programming", "lập trình web" },
                    { 6, true, 2, 1, "6276545", "Game Programming", "lập trình game" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "formal education", new DateTime(2023, 11, 2, 0, 0, 0, 0, DateTimeKind.Local), 1, "GD-IED-CD-18.1", "", "Thiết kế đồ họa", "360/QĐ-CĐFPL", "Associate Degree", "Graphic Design", true, 1, 7, null },
                    { 2, "formal education", new DateTime(2023, 11, 2, 0, 0, 0, 0, DateTimeKind.Local), 4, "GD-IED-IC-19.1", "", "Thiết kế mĩ thuật số", "360/QĐ-CĐFPL", "International associate degree", "Graphic Design", true, 1, 7, null },
                    { 3, "formal education", new DateTime(2023, 11, 2, 0, 0, 0, 0, DateTimeKind.Local), 3, "SE-SE-IC-18.3", "", "kĩ sư phần mềm", "360/QĐ-CĐFPL", "International associate degree", "Software Engineering", true, 4, 7, null },
                    { 4, "formal education", new DateTime(2023, 11, 2, 0, 0, 0, 0, DateTimeKind.Local), 2, "SE-SE-CD-18.2", "", "kĩ thuật phần mềm", "360/QĐ-CĐFPL", "Associate Degree ", "Software Engineering", true, 4, 7, null },
                    { 5, "formal education", new DateTime(2023, 11, 2, 0, 0, 0, 0, DateTimeKind.Local), 3, "CM-FMA-TC-18.3", "", "quản lí học liệu", "360/QĐ-CĐFPL", "Vocational Secondary", "Curriculum Management", true, 2, 7, null },
                    { 6, "formal education", new DateTime(2023, 11, 2, 0, 0, 0, 0, DateTimeKind.Local), 3, "SS-IED-TC-18.3", "", "kĩ năng mềm", "360/QĐ-CĐFPL", "Vocational Secondary", "Soft Skill", true, 1, 7, null },
                    { 7, "formal education", new DateTime(2023, 11, 2, 0, 0, 0, 0, DateTimeKind.Local), 2, "SWP-WP-TC-18.2", "", "kĩ năng lập trình web", "360/QĐ-CĐFPL", "Vocational Secondary", "Skill Web Program", false, 5, 7, null },
                    { 8, "formal education", new DateTime(2023, 11, 2, 0, 0, 0, 0, DateTimeKind.Local), 3, "SS-IED-TC-18.3", "", "kĩ năng mềm", "360/QĐ-CĐFPL", "Vocational Secondary", "Soft Skill", true, 1, 7, null }
                });
